...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        leftPadding = resources.getDimensionPixelSize(R.dimen.three_grid_unit);
...
//
//        params.setMargins(getRight() - getMeasuredWidth(),0, 0, 0);
//        imageView.setLayoutParams(params);

        imageView.setImageResource(R.drawable.ic_arrow_up_white_8);

        // Set the spinner's id into the listview to make it pretend to be the right parent in
        // onItemClick
        listView.setId(getId());
        listView.setDivider( getResources().getDrawable(R.drawable.one_px) );
        listView.setItemsCanFocus(true);
        listView.measure(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
//        listView.layout(getLeft());
...
//            popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.bg_spinner_first_item));
        } else {
//            popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.bg_spinner_first_item));
        }
...
//                onDropDownListener.onDismiss();
    ...
    private void measurePopUpDimension() {
        ...
        params.setMargins((getLeft() + (getWidth()/2)) ,0, 0, 0);
        imageView.setLayoutParams(params);
...
//        popupWindow.setWidth(listView.getMeasuredWidth());
        ...
        popupWindow.setHeight(linearLayout.getMeasuredHeight() - dropDownListPaddingBottom);
    }
    ...
    public void setOnDropDownListener(OnDropDownListener listener) {
        this.onDropDownListener = listener;
    }
