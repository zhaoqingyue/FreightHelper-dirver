...
public abstract class NiceSpinnerBaseAdapter<T> extends BaseAdapter {
    ...
    @Override public View getView(int position, @Nullable View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            int leftPadding = context.getResources().getDimensionPixelSize(R.dimen.three_grid_unit);
            int defaultPadding = context.getResources().getDimensionPixelSize(R.dimen.one_and_a_half_grid_unit);

            textView.setPadding(leftPadding, defaultPadding, defaultPadding, defaultPadding);
