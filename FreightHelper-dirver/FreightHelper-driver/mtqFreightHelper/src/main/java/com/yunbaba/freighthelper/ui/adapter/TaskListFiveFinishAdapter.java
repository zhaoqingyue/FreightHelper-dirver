...
public class TaskListFiveFinishAdapter extends BaseAdapter implements Filterable {

	private ArrayList<MtqHistroyTask> tasklist;
	private Context mContext;

	public TaskListFiveFinishAdapter(Context mContext, ArrayList<MtqHistroyTask> tasklist) {
	...
	@Override
	public MtqHistroyTask getItem(int position) {
		MtqHistroyTask item = null;
		if (null != tasklist) {
	...
	public View getView(final int position, View view, ViewGroup parent) {
		final MtqHistroyTask item = getItem(position);
		ViewHolder holder;
		if (view != null) {
...
//			holder.tv_task_status.setText(mContext.getString(R.string.task_wait));
...
//				taskStatusDrawable.getIntrinsicHeight()* 2/3);
	//	holder.tv_task_status.setCompoundDrawables(taskStatusDrawable, null, null, null);
...
//		TextView tv_more;
	...
	public void setList(ArrayList<MtqHistroyTask> waitingList) {
