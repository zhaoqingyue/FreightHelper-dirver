...
public class Config {
	...
	public static final int appid = 25;          // ols appid
	public static final int apptype = 77;        // ols apptype
	public static final int bussinessid = 24;    // ols bussinessid
	...
	public static final int plan_code = 100100;   // 方案商编号
