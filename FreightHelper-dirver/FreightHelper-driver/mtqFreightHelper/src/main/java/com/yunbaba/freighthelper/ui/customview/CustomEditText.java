...
public class CustomEditText extends EditText{
	...
	private String numStr = "200/200";//咳咳，没空格字数到百位了绘制的字数统计就撮到屏幕外面去了，有更好的方式的话请指教
	...
	public CustomEditText(Context context, AttributeSet attrs) {
		...
		mPaint = new Paint();
		int colorGray = getResources().getColor(R.color.tasklist_text_color);
		...
		viewTreeObserver.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
			...
			public void onGlobalLayout() {
				...
				editHeight = edit.getMeasuredHeight();
			}
		});	
	}
	...
	protected void onDraw(Canvas canvas) {
		super.onDraw(canvas);
		//绘制字数统计
		canvas.drawText(numStr, editWidth-mBound.width(), editHeight-mBound.height(), mPaint);
	}
	@Override
